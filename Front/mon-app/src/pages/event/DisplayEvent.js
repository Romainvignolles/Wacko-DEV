    ...
    const fetchOneEvent = () => {              //recupération des events
        ...
        axios({
            ...
            .then((res) => {
                ...
                document.querySelector(".displayEvent__title").style.backgroundColor = res.data.topColor
                let title = document.querySelectorAll(".displayEvent__titleColor")
                for (const elem of title) {
                    elem.style.color = res.data.titleColor
                }
                document.querySelector("#eventDescription").style.backgroundColor = res.data.textColor
