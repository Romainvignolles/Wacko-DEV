        ...
        <div className="displayEvent">
            <div className="displayEvent__info">
                <div className="displayEvent__title" >
                    {/* { userAdmin === true && <button onClick={modifyEvent}>Modifier/Supprimer</button>} */}
